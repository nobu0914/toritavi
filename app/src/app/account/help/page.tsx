...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    body:
      ...
      "・端末のシステム設定で JUNROS の通知が許可されているか\n" +
      ...
      <Box pb={110}>
        ...
        <Card>
          ...
          <Row
            ...
            href="mailto:info@coyoteandpowell.com?subject=%E4%B8%8D%E5%85%B7%E5%90%88%E3%81%AE%E5%A0%B1%E5%91%8A"
          />
          <Row
        ...
        <Card>
          <Row
            ...
            label="利用規約"
            href="https://coyoteandpowell.com/junros/terms/"
          />
          <Row
